...
namespace MediaPortal.GUI.Video
{
  ...
  /// </summary>
  public class DelayedVideosFileSystemWatcher
  {
    ...
    public DelayedVideosFileSystemWatcher()
    {
      this._fileSystemWatcher = new FileSystemWatcher();
      this.Initialize();
    }

    public DelayedVideosFileSystemWatcher(string path)
    {
      this._fileSystemWatcher = new FileSystemWatcher(path);
      this.Initialize();
    }

    public DelayedVideosFileSystemWatcher(string path, string filter)
    {
